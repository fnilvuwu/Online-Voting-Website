          ...
          <div class="box"style="background-color: #d8d1bd">
            ...
            <div class="box-body">
              <table id="example1" class="table ">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, candidates.fullname AS canfullname, voters.fullname AS votfullname FROM votes LEFT JOIN positions ON positions.id=votes.position_id LEFT JOIN candidates ON candidates.id=votes.candidate_id LEFT JOIN voters ON voters.id=votes.voters_id ORDER BY positions.priority ASC";
                    ...
                    while($row = $query->fetch_assoc()){
                      echo "
                        <tr style='color:black ; font-size: 15px; font-family:Times'>
                          ...
                          <td>".$row['canfullname']."</td>
                          <td>".$row['votfullname']."</td>
                        </tr>
                      ";
                    }
                  ?>
