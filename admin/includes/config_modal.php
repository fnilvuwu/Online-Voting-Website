    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #d8d1bd ;color:black ; font-size: 15px; font-family:Times ">
            ...
            <div class="modal-body">
              <div class="text-center">
                ...
                <form class="form-horizontal" method="POST" action="config_save.php?return=<?php echo basename($_SERVER['PHP_SELF']); ?>">
                  ...
                  <div class="form-group">
                    <label for="voting_status" class="col-sm-3 control-label">Voting Status</label>
                    <div class="col-sm-9">
                      <select class="form-control" id="voting_status" name="voting_status">
                        <option value="true" <?php echo $voting_status ? 'selected' : ''; ?>>Running</option>
                        <option value="false" <?php echo !$voting_status ? 'selected' : ''; ?>>Stopped</option>
                      </select>
                    </div>
                  </div>
              </div>
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-success btn-curve" style='background-color: #9CD095 ;color:black ; font-size: 12px; font-family:Times' name="save"><i class="fa fa-save"></i> Save</button>
              </form>
            </div>
        </div>
    </div>
