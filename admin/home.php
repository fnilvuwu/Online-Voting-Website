    ...
    <div class="content-wrapper" style="background-color: #F1E9D2 ">
      ...
      <section class="content">
        ...
        <div class="row" style="color:black ; font-size: 17px; font-family:Times">
          <div class="col-xs-12">
            <h3> <b>Perhitungan Suara
                <span class="pull-right">
                  <a href="print.php" class="btn btn-success btn-sm btn-curve" style="background-color:rgb(110, 157, 130); font-size: 16px; color: black; font-family:Times "><span class="glyphicon glyphicon-print"></span> Print</a>
                </span>
              </b> </h3>
          </div>
        </div>
