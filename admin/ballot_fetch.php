<?php
    ...
    while($row = $query->fetch_assoc()){
        ...
        while($crow = $cquery->fetch_assoc()){
            ...
            $candidate .= '
                <li>
                    '.$input.'<button class="btn btn-primary btn-sm btn-curve clist" style="background-color: #4682B4 ;color:black ; font-size: 12px; font-family:Times"><i class="fa fa-search"></i> Platform</button><img src="'.$image.'" height="100px" width="100px" class="clist"><span class="cname clist">'.$crow['fullname'].'</span>
                </li>
            ';
        }
